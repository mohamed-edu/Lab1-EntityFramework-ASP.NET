...
namespace Lab1_EntityFramework.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        public LeaveTypesController(Lab1DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LeaveTypeId,LeaveReason")] LeaveType leaveType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LeaveTypeId,LeaveReason")] LeaveType leaveType)
        {
